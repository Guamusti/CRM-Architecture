...
const ROLE_PERMISSIONS = {
  owner:   ['crm:read', 'crm:create', 'crm:update', 'crm:delete', 'crm:assign', 'crm:close', 'crm:pipeline:manage'],
  admin:   ['crm:read', 'crm:create', 'crm:update', 'crm:delete', 'crm:assign', 'crm:close', 'crm:pipeline:manage'],
  manager: ['crm:read', 'crm:create', 'crm:update', 'crm:assign', 'crm:close'],
